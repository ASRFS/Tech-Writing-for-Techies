...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<asciimath>.freeze, ["~> 1.0.0".freeze])
  s.add_development_dependency(%q<coderay>.freeze, ["~> 1.1.0".freeze])
  ...
  s.add_development_dependency(%q<erubis>.freeze, ["~> 2.7.0".freeze])
  s.add_development_dependency(%q<haml>.freeze, ["~> 5.0.0".freeze])
  s.add_development_dependency(%q<minitest>.freeze, ["~> 5.11.0".freeze])
  s.add_development_dependency(%q<nokogiri>.freeze, ["~> 1.10.0".freeze])
  s.add_development_dependency(%q<rake>.freeze, ["~> 12.3.0".freeze])
  s.add_development_dependency(%q<rouge>.freeze, ["~> 3.3.0".freeze])
  s.add_development_dependency(%q<rspec-expectations>.freeze, ["~> 3.8.0".freeze])
  s.add_development_dependency(%q<slim>.freeze, ["~> 4.0.0".freeze])
