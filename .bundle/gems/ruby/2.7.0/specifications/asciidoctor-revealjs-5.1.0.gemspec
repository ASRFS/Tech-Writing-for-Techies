# -*- encoding: utf-8 -*-
# stub: asciidoctor-revealjs 5.1.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<asciidoctor-templates-compiler>.freeze, ["~> 0.7.0"])
    ...
    s.add_dependency(%q<asciidoctor-templates-compiler>.freeze, ["~> 0.7.0"])
